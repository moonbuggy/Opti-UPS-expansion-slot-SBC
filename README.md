...
### Assembled
> [!NOTE]
> These photos currently show an earlier revision of the Rock Pi S board.
...
sudo sed -E 's|(trigger=).*$|\1disable|' -i /etc/armbian-leds.conf
...
### Fan Connector
The inbuilt fan in my UPS doesn't seem to spin. It's not clear at this stage if
it's a faulty fan or a fault in its supply. The 4-wire fan connector provides
the option to power and control a 12V fan from this board.
